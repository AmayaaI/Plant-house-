...
public class UserDao {
    ...
    public static void save(User user) {
        ...
        DBOperations.setDataOrDelete(query, "Registered Successfully! Wait for Admin Approvall");
    }
    ...
    public static User getSecurityQuestion(String emaill) {
        User user = null;
        try {
            String email = null;
    ...
    public static void changePassword(String email,String oldPassword,String newPassword){
      try{
          ResultSet rs = DBOperations.getData("select * from user where email='"+email+"' and password='"+newPassword+"'");
          if(rs.next()){
